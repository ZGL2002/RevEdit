...
\newcommand{\trigLlOod}{0.995}
\newcommand{\trigLlMb}{0.981}

% ---------- 双水印 ----------
\newcommand{\dwBoth}{A: 0.993 / B: 1.000}
\newcommand{\dwAfterB}{A: 1.000 / B: 0.429$^{\dagger}$}  % dagger = clean 模型固有翻转率（实测）
\newcommand{\dwAfterA}{A: 0.000 / B: 0.429$^{\dagger}$}
